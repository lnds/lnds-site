...
featured_image: "https://d2dspjyoh5c79p.cloudfront.net/61328383-5f0b-11e9-8e69-21c4c306beae-aa9f18b7"
...
[La primera canción de [Dave Mathews
Band](https://www.davematthewsband.com/), ]{style="font-size: 20px; letter-spacing: 0.01rem;"}[que
recuerdo haber escuchado, ]{style="letter-spacing: 0.01rem;"}[es una
versión en vivo de ]{style="letter-spacing: 0.01rem;"}["Ants
Marching"](https://www.youtube.com/watch?v=GhswH1bLMy8)[, me gustó tanto
que la usé en la banda sonora de un video familiar que hice de nuestras
vacaciones de veranos del 2004. ]{style="letter-spacing: 0.01rem;"}

[Fuimos a La Serena ese año, compré la cámara de video allá mismo. Hay
hermosos y divertidos momentos de mis hijos mayores jugando con
Francisca, que acababa de cumplir dos
años. ]{style="font-size: 20px; letter-spacing: 0.01rem;"}
...
crisis, [que les conté en la parte
6](https://www.lnds.net/blog/lnds/2019/4/6/el-fin-de-la-agilidad),
...
]{style="font-size: 20px; letter-spacing: 0.01rem;"}
...
![Handkey II
device](https://d2dspjyoh5c79p.cloudfront.net/b0beba81-5f07-11e9-8e69-21c4c306beae-aa9f18b7)
:::
...
podía escalar este negocio por falta de software
adecuado.]{style="letter-spacing: 0.01rem;"}\
...
biometría.]{style="letter-spacing: 0.01rem;"}
...
café cercano.]{style="letter-spacing: 0.01rem;"}
...
relevantes.]{style="letter-spacing: 0.01rem;"}
...
::: {.medium-insert-images}
![El proceso para tomar decisiones en una arquitectura de
software](https://d2dspjyoh5c79p.cloudfront.net/261bfa22-5f0a-11e9-8e69-21c4c306beae-aa9f18b7)
:::
...
transacción.]{style="letter-spacing: 0.01rem;"}
...
plataforma .Net de Microsoft.]{style="letter-spacing: 0.01rem;"}\
...
del backend.]{style="letter-spacing: 0.01rem;"}
...
alianzas y prospectaba negocios.]{style="letter-spacing: 0.01rem;"}

<div>

Sin embargo, creo que caímos en uno de los errores que Roberto Camhi,
[en este reciente
artículo](http://robertocamhi.com/4-pecados-capitales-del-emprendedor/)
...
[Sonará arrogante, sin embargocreo que ninguna empresa relevante que se
...
negocios.]{style="letter-spacing: 0.01rem;"}
...
[Les daré un ejemplo de lo que hacíamos en BioKey
Technologies. ]{style="letter-spacing: 0.01rem;"}

Nuestra plataforma ofrecía un modelo de seguridad basado en el trabajo
de Ratha, Connel y Bolle, que se detalla en [este
paper](https://www.researchgate.net/profile/Jonathan_Connell/publication/220353130_Enhancing_Security_and_Privacy_in_Biometrics-Based_Authentication_Systems/links/555a010508ae6fd2d8281b10/Enhancing-Security-and-Privacy-in-Biometrics-Based-Authentication-Systems.pdf)
...
::: {.medium-insert-images}
![El modelo de Ratha, Connel y
Bolle.](https://d2dspjyoh5c79p.cloudfront.net/2ab95335-5f0e-11e9-8e69-21c4c306beae-aa9f18b7)
:::
...
significaría mejores sueldos.]{style="letter-spacing: 0.01rem;"}
...
adelante la encontré en la
escritura. ]{style="letter-spacing: 0.01rem;"}[En agosto de 2005 empecé
...
Marching Dave Mathews escribe:]{style="letter-spacing: 0.01rem;"}
...
convenio con las universidades chilenas en 2007 para [desarrollar
algoritmos que facilitaran la utilización de soluciones biométricas en
Chile](http://e-ciencia.reuna.cl/T2007/Ten_02/doc/WG_CSc_e-science-CEMCC.pdf).
...
identificado por Roberto Camhi, es lo que él denomina [\"foco
producto\"](http://robertocamhi.com/que-el-foco-producto-no-termine-matando-tu-producto/).
...
discusión con mis socios.  ]{style="letter-spacing: 0.01rem;"}
...
parte.]{style="letter-spacing: 0.01rem;"}
